...
- Loss: 0.00024060233116745625
- Accuracy: 100.0 ( or 99.9999 -> ad infinitum)
...
def backwards(x, mini_onehot, w2, a2, a1, g2, g1, z2_l, z2_std, z1_l, z1_std, z1_norm):
    ...
    dg2 = dz2_norm * z2_l
    db2 =  np.sum(dz2_norm, axis = 1, keepdims = True) / mini_onehot.shape[1]
    ...
    dg1 = dz1_norm * z1_l
    db1 = np.sum(dz1_norm, axis = 1, keepdims = True) / mini_onehot.shape[1] 
